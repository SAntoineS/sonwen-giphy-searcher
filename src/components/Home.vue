<template>
 <div class="outline-none font-poppins text-black dark:bg-darkGrayPalette dark:text-white">
    <toolbar></toolbar>
    ...
    <NotificationGroup group="error">
      <div class="fixed inset-0 flex items-start justify-end p-6 px-4 py-6 pointer-events-none">
        <div class="w-full max-w-sm">
          ...
          >
        <div
          class="flex w-full max-w-sm mx-auto mt-4 overflow-hidden bg-white rounded-xl shadow-md"
        ...
        <div class="px-4 py-2 -mx-3">
          <div class="mx-3">
            ...
            <p class="text-sm text-black">{{ notification.text }}</p>
          </div>
        </div>
        </div>
      </Notification>
            ...
            >
              ...
              <div class="px-4 py-2 -mx-3">
                <div class="mx-3">
                  ...
                  <p class="text-sm text-grayWeb">{{ notification.text }}</p>
                </div>
              </div>
            </div>
          </Notification>
